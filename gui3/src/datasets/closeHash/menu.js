export default [
...

  {
    ...
    "action": function (event, castomThis) {
      ...
      castomThis. $axios. get ("/api/closeHash/save"). then ( data => alert ("Сохранено!"));
...

  {
    ...
    "action": function (event, castomThis) {
      ...
      castomThis. $axios. get ("/api/closeHash/globRemove"). then ( data => {

        castomThis. $bus. $emit ("TableCloseHashDataset");
